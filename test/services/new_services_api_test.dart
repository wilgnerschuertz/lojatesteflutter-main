...
import 'package:lojatesteflutter/services/http_client_interface.dart';
...
void main() {
  test(
    'deve retornar o TITLE do produto',
    () async {
      ...
      when(() => client.get(url)).thenAnswer(
        (_) async => jsonDecode(jsonResponse),
      );

      final service = ApiProduct(client);
      final todos = await service.getProducts();
      expect(
        todos[0].title,
